...
public class NetworkEnvironmentOptMinCh extends Environment {
            ...
            switch (language.getActionIndex(act)) {
                ...
                case 2: //Send shares new information to neighbors
                    ...
                    if (!(((ArrayList) (a.getAttribute("ch_in"))).isEmpty()) || !(((ArrayList) (a.getAttribute("ch_out"))).isEmpty())) {
                        ...
                        System.out.println("Agents that finished:" + controlBoard.getInstance().getSize());
    ...
    public NetworkEnvironmentOptMinCh(Vector<Agent> _agents, SimpleLanguage _language, Graph gr) {
        super(_agents);
    ...
    public NetworkEnvironmentOptMinCh(Agent agent, SimpleLanguage _language, Graph gr) {
        super(agent);
        this.g = gr;
        language = _language;
    }

    public NetworkEnvironmentOptMinCh copy() {
        return new NetworkEnvironmentOptMinCh(agents, language, g);
    }
