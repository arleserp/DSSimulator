...
public class NetworkEnvironmentOptRoutingPrCh extends Environment implements Serializable{
    ...
    public NetworkEnvironmentOptRoutingPrCh(Vector<Agent> _agents, SimpleLanguage _language, Graph gr) {
        super(_agents);
    ...
    public NetworkEnvironmentOptRoutingPrCh(Agent agent, SimpleLanguage _language, Graph gr) {
        super(agent);
        this.g = gr;
        language = _language;
    }

    public NetworkEnvironmentOptRoutingPrCh copy() {
        return new NetworkEnvironmentOptRoutingPrCh(agents, language, g);
    }
