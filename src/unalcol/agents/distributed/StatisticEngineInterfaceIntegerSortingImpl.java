 ...
 */
public class StatisticEngineInterfaceIntegerSortingImpl implements StatisticEngineInterface {

    private ArrayList expectedRes;
    ...
    Hashtable getStatisticsInteger() {
        ...
        for (Iterator<Hashtable> iterator = outtmp.keySet().iterator(); iterator.hasNext();) {
            ...
            ArrayList[] tmpvalues = Arrays.copyOf(tmp, tmp.length, ArrayList[].class);
            for (ArrayList t : tmpvalues) {
                //System.out.println("exp Res" + expectedRes.size());
                //System.out.println("exp val" + t.size());
                
                if (expectedRes.equals(t)) {
                    right++;
                } else {
                    wrong++;
                }
    ...
    public void printStatistics(int n) {
        ...
        try {
            ...
            Logger.getLogger(NetworkEnvironment.class
    ...
    public void setExpectedRes(Object res) {
        this.expectedRes = (ArrayList) res;
    }
