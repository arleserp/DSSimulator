 ...
 */
public class FileExperimentDAOInterfaceIntegerAvgImpl implements FileExperimentDAOInterface {
    ...
    public void createNew(String filename, int agentsNumber, int channelsNumber, int eppsteinEvolutions) {
        ...
        System.out.println("age:" + agentsNumber);
        Graph<String, String> g = new Lattice2DGenerator(new GraphCreator.GraphFactory(), v, new GraphCreator.EdgeFactory(), 5,5, false).create();
    ...
    public void loadExp(String filename, FunctionComputingInterface F, AgentProgram ap, Language languaje, String reportsFileOutput) {
        ...
        //Expected result
        double expectedRes = dataset.avg();
        
        System.out.println("agents:" + dataset.getAgentsNumber());
        //Create Agents
        ...
        StatisticEngineInterface stat = new StatisticEngineInterfaceIntegerAvgImpl();
