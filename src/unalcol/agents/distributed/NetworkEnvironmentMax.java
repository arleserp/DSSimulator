...
public class NetworkEnvironmentMax extends Environment {
    ...
    public NetworkEnvironmentMax(Vector<Agent> _agents, SimpleLanguage _language, Graph gr) {
        super(_agents);
    ...
    public NetworkEnvironmentMax(Agent agent, SimpleLanguage _language, Graph gr) {
        super(agent);
        this.g = gr;
        language = _language;
    }

    public NetworkEnvironmentMax copy() {
        return new NetworkEnvironmentMax(agents, language, g);
    }
