...
public class NetworkEnvironmentOptMax extends Environment {
    ...
    public NetworkEnvironmentOptMax(Vector<Agent> _agents, SimpleLanguage _language, Graph gr) {
        super(_agents);
    ...
    public NetworkEnvironmentOptMax(Agent agent, SimpleLanguage _language, Graph gr) {
        super(agent);
        this.g = gr;
        language = _language;
    }

    public NetworkEnvironmentOptMax copy() {
        return new NetworkEnvironmentOptMax(agents, language, g);
    }
