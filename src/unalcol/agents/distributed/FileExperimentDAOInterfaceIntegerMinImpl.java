 ...
 */
public class FileExperimentDAOInterfaceIntegerMinImpl implements FileExperimentDAOInterface {
    ...
    public void loadExp(String filename, FunctionComputingInterface F, AgentProgram ap, Language languaje, String reportsFileOutput) {
        ...
        StatisticEngineInterface stat = new StatisticEngineInterfaceIntegerMinImpl();
