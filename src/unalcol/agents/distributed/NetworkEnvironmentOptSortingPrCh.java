...
public class NetworkEnvironmentOptSortingPrCh extends Environment {
        ...
        if (flag) {
            ...
            switch (language.getActionIndex(act)) {
                ...
                case 1: // Receive
                    ...
                    ArrayList out = HashtableOperations.Sort(aux, (Hashtable)a.getAttribute("infi"));
                        
                    //int out = Math.min((int) HashtableOperations.Minimum(aux), (int) HashtableOperations.Minimum((Hashtable) a.getAttribute("infi")));
    ...
    public NetworkEnvironmentOptSortingPrCh(Vector<Agent> _agents, SimpleLanguage _language, Graph gr) {
        super(_agents);
    ...
    public NetworkEnvironmentOptSortingPrCh(Agent agent, SimpleLanguage _language, Graph gr) {
        super(agent);
        this.g = gr;
        language = _language;
    }

    public NetworkEnvironmentOptSortingPrCh copy() {
        return new NetworkEnvironmentOptSortingPrCh(agents, language, g);
    }
