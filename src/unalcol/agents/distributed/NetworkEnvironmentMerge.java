...
public class NetworkEnvironmentMerge extends Environment {
            ...
            switch (language.getActionIndex(act)) {
                ...
                case 1: // Receive
                    ...
                    if(newh.isEmpty()){
                       ...
                       // System.out.println("ag" + a.getAttribute("ID") + "aux" + aux);
                        ...
                        //compute maximum
                        //int out = Math.max((int)HashtableOperations.Maximum(aux),(int)HashtableOperations.Maximum((Hashtable)a.getAttribute("infi")));
    ...
    public NetworkEnvironmentMerge(Vector<Agent> _agents, SimpleLanguage _language, Graph gr) {
        super(_agents);
    ...
    public NetworkEnvironmentMerge(Agent agent, SimpleLanguage _language, Graph gr) {
        super(agent);
        this.g = gr;
        language = _language;
    }

    public NetworkEnvironmentMerge copy() {
        return new NetworkEnvironmentMerge(agents, language, g);
    }
