...
public class NetworkEnvironmentMAS extends Environment implements Serializable {
    ...
    public NetworkEnvironmentMAS(Vector<Agent> _agents, SimpleLanguage _language, Graph gr, FunctionComputingInterface f, String fn, StatisticEngineInterface stat) {
        super(_agents);
    ...
    public NetworkEnvironmentMAS(Vector<Agent> _agents, SimpleLanguage _language, Graph gr) {
        super(_agents);
        //this.g = new SparseMultigraph();
        int n = _agents.size();
        for (int i = 0; i < n; i++) {
    ...
    public NetworkEnvironmentMAS(Agent agent, SimpleLanguage _language, Graph gr) {
        super(agent);
        this.g = gr;
        language = _language;
    }

    public NetworkEnvironmentMAS copy() {
        return new NetworkEnvironmentMAS(agents, language, g);
    }
